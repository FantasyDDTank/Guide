...
let starttime02 = new Date('November 1, 2021 00:00:00').getTime();
let countDown02 = new Date('November 9, 2021 00:00:00').getTime(),
    y = setInterval(function() {
        ...
        if (distance02 < 0) {
            clearInterval(y);
            document.getElementById("countdown-02").style.display = 'none';
